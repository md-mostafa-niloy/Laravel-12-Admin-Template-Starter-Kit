<section>
    <div class="card">
        <div class="card-header">
            ...
            <p class="text-muted mb-0">{{ __('Manage and log out your active sessions on other browsers and devices.') }}
            </p>
        </div>
        <div class="card-body">
            <p class="text-muted">
                            ...
                            <div>
                                @if ($session->agent->isDesktop())
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                        stroke-width="1.5" stroke="currentColor" style="width: 35px; height: 35px"
            ...
            <div class="d-flex align-items-center mt-2">
                <button class="btn btn-secondary" data-bs-toggle="modal" wire:click="confirmLogout"
            ...
            <x-dialog-modal wire:model.live="confirmingLogout">
                ...
                <x-slot name="footer">
                    <button class="btn btn-secondary" wire:click="$toggle('confirmingLogout')"
                        wire:loading.attr="disabled">
                        {{ __('Cancel') }}
                    </button>

                    <button class="btn btn-danger" class="ms-3" wire:click="logoutOtherBrowserSessions"
                        wire:loading.attr="disabled">
                        {{ __('Log Out Other Browser Sessions') }}
                    </button>
                </x-slot>
